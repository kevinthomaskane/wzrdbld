...
class Main extends Component {
  ...
  componentWillMount(){
    const leftVideos = ['/videos/vid-leftv2.mp4', '/videos/vid-mobile.mp4'];
    const i = Math.floor(Math.random() * 2)
    this.setState({
      leftVid: leftVideos[i],
      rightVid: '/videos/vid-rightv2.mp4'
    })
  }
